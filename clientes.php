...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['nombres'])) {
    ...
    // Si el tipo de documento NO es 'Indocumentado', el número de documento es obligatorio.
    if ($tipoDocumento !== 'Indocumentado' && empty($numeroDocumento)) {
        $_SESSION['mensaje'] = "El número de documento es obligatorio para el tipo de documento seleccionado.";
        $_SESSION['tipo'] = "error";
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // --- NUEVO SCRIPT PARA VALIDACIÓN DINÁMICA ---
        const tipoDocumentoSelect = document.getElementById('tipoDocumento');
        const numeroDocumentoInput = document.getElementById('numeroDocumento');

        // Función para actualizar la obligatoriedad del campo
        ...
        // Ejecutar la función al cargar la página y cuando cambie el select
        updateDocumentRequired();
        tipoDocumentoSelect.addEventListener('change', updateDocumentRequired);
    });
</script>
